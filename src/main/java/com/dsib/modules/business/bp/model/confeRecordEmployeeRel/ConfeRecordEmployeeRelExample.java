package com.dsib.modules.business.bp.model.confeRecordEmployeeRel;

import java.util.ArrayList;
import java.util.Date;
import java.util.List;

public class ConfeRecordEmployeeRelExample {
    ...
    public ConfeRecordEmployeeRelExample() {
    ...
    /**
     * PMS_CM_CONFERECORDEMPLOYEE_REL 2017-11-09
     */
    ...
    /**
     * 描述:PMS_CM_CONFERECORDEMPLOYEE_REL表的实体类
     * @version
     * @author:  DK_Tyh
     * @创建时间: 2017-11-09
     */
