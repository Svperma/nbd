...
import com.dsib.common.utils.ArrayUtil;
...
public class AutoTimeAspect {
    ...
    @Pointcut("execution(* com.dsib.modules.business.*..controller..*.insert*(..))")
    ...
    @Pointcut("execution(* com.dsib.modules.business.*..controller..*.update*(..))")
